...
import {getFollowList} from './../axios/api.js'
export default {
  components: {
    'headTitle': title
  },
  ...
  mounted () {
    getFollowList().then(res => {
      this.follws = res.data
      this.follwsReady = true
    }).catch(err => {
